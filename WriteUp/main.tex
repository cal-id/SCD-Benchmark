...
\section{Results}
    ...
    \subsection{IMB PingPong}
        ...
        \begin{landscape}
            ...
            \label{figure:asdfasdfa}
            \end{figure}


            % \begin{center}
            %     \includegraphics[]{compare_bandwidth-hostgroup_1024}
            %     \captionsetup{type=figure}
            %     \caption{1024B}
            % \end{center}
            % \begin{center}
            ...
            %     \includegraphics[width=\textwidth]{compare_bandwidth-hostgroup_max}
            %     \captionsetup{type=figure}
            %     \caption{Maximum over all message sizes}
            % \label{figure:compare-bandwidths-container}
            % \end{center}
