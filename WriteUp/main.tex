...
\section{Results}
    ...
    \subsection{IMB PingPong}
        ...
        \subsubsection{Comparison of Latency}
            ...
            \paragraph{}
            The method of communication has a clear impact on latency (see Figure \ref{fig:compare_latency-hostgroup}). Even ignoring the impact of host group, all the mean results for each host group for SHM-1 are lower than SHM-2 which are lower than IBV which are lower than TCP. As the processes need to communicate further, latency rises.
