...
\section{Results}
    ...
    \subsection{IMB PingPong}
        ...
        \subsubsection{Comparison of Latency}
            ...
            \paragraph{}
            Figure \ref{fig:compare_bandwidth-hostgroup_max} shows a comparison of the results for bandwidth (see Appendix \ref{appendix:bandwidth-data} for the data).

            \paragraph{}
            In general, for each host group, the ranking of the protocols is the same: SHM-1, SHM-2, IBV and then TCP. In the same way as latency increases, bandwidth TODO
